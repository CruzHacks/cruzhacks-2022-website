  ...
  plugins: [
    new webpack.DefinePlugin({
      "process.env": {
        ...
        REACT_APP_MAILCHIMP_API: JSON.stringify(process.env.REACT_APP_MAILCHIMP_API),
        ...
        REACT_APP_ANNOUNCEMENTS_ENDPOINT: JSON.stringify(process.env.REACT_APP_ANNOUNCEMENTS_ENDPOINT),
        REACT_APP_APPLICATION_ENDPOINT: JSON.stringigy(process.env.REACT_APP_APPLICATION_ENDPOINT),
      },
    }),
  ],
}
